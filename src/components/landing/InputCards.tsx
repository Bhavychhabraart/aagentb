            ...
            <div className={cn(
              ...
              {card.hasContent && (
                <button
                  ...
                  className="absolute top-2 right-2 p-1.5 rounded-full bg-background/90 border border-border opacity-0 group-hover:opacity-100 transition-all hover:bg-destructive hover:border-destructive hover:text-destructive-foreground z-10"
                >
                  <X className="w-3 h-3" />
                </button>
              )}
          ...
          >
            ...
            {pill.hasContent ? (
              <span className="flex items-center gap-1">
                <span className="text-xs text-primary">{pill.count || "✓"}</span>
                <button
